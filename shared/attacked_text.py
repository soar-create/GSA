...
class AttackedText:
    ...
    def __init__(self, text_input, attack_attrs=None):
        ...
        self._words = None
        self._premisewords = None
        self._hypothesiswords=None
    ...
    @property
    def sentence1text(self):
        return self._text_input["sentence1"]
    
    @property
    def sentence1words(self):
        if not self._sentence1words:
            self._sentence1words = words_from_text(self.sentence1text)
        return self._sentence1words
    @property
    def sentence2text(self):
        return self._text_input["sentence2"]
    
    @property
    def sentence2words(self):
        if not self._sentence2words:
            self._sentence2words = words_from_text(self.sentence2text)
        return self._sentence2words
